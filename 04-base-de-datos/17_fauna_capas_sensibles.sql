...
-- Siembra solo si las capas están vacías. Antes borraba y reinsertaba, así que
-- re-ejecutarla eliminaba lo cargado después (las cámaras C2–C7 del 18-sep-2026).
DO $siembra$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM eco_restauracion.capas_geograficas
                 WHERE capa IN ('fauna_aves_camaras','herpetos')) THEN
